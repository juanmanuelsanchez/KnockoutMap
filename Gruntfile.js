...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    jsdoc: {
        ...
        // Tell JSDoc where to find the JavaScript files for this project, and where
  ...
  grunt.registerTask("build", ["clean", "copy",/* "jshint",*//* "jasmine",*/"concat", "uglify", "jsdoc"]);
};